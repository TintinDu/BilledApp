...
const row = (bill) => `
    <tr> 
      ...
      <td>${bill.status}</td>
      <td>
        ${!bill.fileUrl.endsWith('null') ? Actions(bill.fileUrl) : `<div class="icon-forbidden">
        <div id="eye-forbidden" data-testid="icon-eye-forbidden">
  ...
  return `
    <div class='layout'>
      ...
      <div class='content'>
        ...
        <div id="data-table">
        <table id="example" class="table table-striped" style="width:100%" data-testid="table">
          <thead>
              <tr>
                <th>Type</th>
                <th>Nom</th>
