      ...
      <div class='dashboard-content'>
        <div class='bills-feed'>
          <div class='status-bills-header'>
            <h3> En attente (${filterBills(data && data.bills, 'pending').length}) </h3>
          ...
          <div class='status-bills-container' id='status-bills-container1'>
            ...
            <div class='status-bills-header' style='margin-top: 20px;'>
              <h3> Validé (${filterBills(data && data.bills, 'accepted').length}) </h3>
            ...
            <div class='status-bills-header' style='margin-top: 20px;'>
              <h3> Refusé (${filterBills(data && data.bills, 'refused').length}) </h3>
